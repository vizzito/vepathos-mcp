...
| # | Say | Pass when |
|---|---|---|
| C5.1 | `para mañana usá 25 vehículos` | **`manage_vehicle` is never called.** The 25 travels as `count`. |
| C5.2 | `agregame a mi cuenta una Sprinter de 1.500 kg y 14 m³` | Asks, then one `manage_vehicle`. Does not optimize. |
